    ...
    return (
        <div className="flex h-screen bg-background overflow-hidden animate-fade-in">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden relative">
                ...
                {activeLesson ? (
                    <div className="flex-1 overflow-y-auto">
                        <div className="bg-black aspect-video w-full max-h-[70vh] flex items-center justify-center">
                        ...
                        <div className="max-w-4xl mx-auto p-8">
                            <div className="flex justify-between items-start mb-6">
                                ...
                                {/* Next Lesson Button Logic could go here */}
                            </div>

                            <div className="prose prose-invert max-w-none">
                                <p className="text-gray-300 whitespace-pre-line">{activeLesson.content}</p>
                            </div>
                        </div>
                    </div>
                ) : (
