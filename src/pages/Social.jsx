...
import { collection, query, orderBy, onSnapshot, where, getDocs, doc, getDoc, updateDoc, arrayUnion, arrayRemove } from 'firebase/firestore';
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(q, (snapshot) => {
            ...
            const filteredPosts = fetchedPosts.filter(post => {
                ...
                // Note: Better to check if auth.uid is in post author's friend list.
                // For simplicity, assuming if I am their friend, they are mine (bi-directional).
        ...
        return () => unsubscribe();
    }, [userFriends]); // Re-run if friends change
        ...
        <div className="min-h-screen bg-background pt-20 pb-10">
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Left Sidebar (Profile Summary / Shortcuts) - Hidden on mobile */}
                        ...
                        {activeTab === 'friends' && (
                            <div className="bg-surface rounded-xl border border-gray-800 p-6">
                                ...
                                {userFriends.length > 0 ? (
                                    ...
                                    <p className="text-gray-400">No friends yet. Search for users to add them!</p>
                                )}
                            </div>
                        )}
